...
public interface HistorialEstadoTransaccionRepository extends JpaRepository<HistorialEstadoTransaccion, Integer> {
    List<HistorialEstadoTransaccion> findByTransaccionCodeOrderByFechaEstadoCambioDesc(Integer transaccionId);

    List<HistorialEstadoTransaccion> findByEstado(String estado);

    List<HistorialEstadoTransaccion> findByFechaEstadoCambioBetweenOrderByFechaEstadoCambioDesc(LocalDateTime fechaInicio, LocalDateTime fechaFin);
}
